...
const Interest = () => {
    ...
    const handleInterest = async (e) => {
        ...
        try {
            await axios.post('https://bankapp-b5kg.onrender.com/api/transactions/interest', { to, amount }, {
    ...
    return (
        <section className='flex-grow bg-white dark:bg-cyan-900 p-6 rounded-lg shadow-md'>
            <h2 className="text-xl font-bold text-center mb-4 dark:text-white">Interés</h2>
